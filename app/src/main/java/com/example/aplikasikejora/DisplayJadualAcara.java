...
public class DisplayJadualAcara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_jadual_acara);
        recyclerView = findViewById(R.id.JadualAcaraDisplay);
        ...
        Adapter1 = new FirestoreRecyclerAdapter<RetrieveAcara,RetrieveJadualHolder>(options) {
            ...
            public RetrieveJadualHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_jadual,parent,false);
            ...
            protected void onBindViewHolder(@NonNull RetrieveJadualHolder holder1, int position, @NonNull RetrieveAcara model1) {
                holder1.Kategori.setText(model1.getKategori());
                holder1.NamaAcara.setText(model1.getNamaAcara()+" "+model1.getJantina());
    ...
    private class RetrieveJadualHolder extends RecyclerView.ViewHolder{
        ...
        TextView Kategori,NamaAcara,Tarikh;

        public RetrieveJadualHolder(@NonNull View itemView) {
            super(itemView);

            Kategori=itemView.findViewById(R.id.JadualKategoriDisplay);
            NamaAcara = itemView.findViewById(R.id.JadualNamaAcaraDisplay);
            Tarikh = itemView.findViewById(R.id.JadualDisplay);
