...
public class KeputusanMengikutAcara extends AppCompatActivity {

    Spinner mAcaraKeputusan;
    Button mDisplayKeputusan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keputusan_mengikut_acara);

        mAcaraKeputusan = findViewById(R.id.AcaraKeputusan);
        mDisplayKeputusan= findViewById(R.id.DisplayKeputusanBtn);
        ...
        mAcaraKeputusan.setAdapter(dataAdapter);
        ...
        mDisplayKeputusan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Acara=String.valueOf(mAcaraKeputusan.getSelectedItem());
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                            ...
                            if(Objects.equals(Acara, Temp4)) {
                                ...
                                Intent i = new Intent(v.getContext(),DisplayKeputusanMengikutAcara.class);
