...
public class KeputusanAcara1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keputusan_acara1);

        mAcara = findViewById(R.id.AcaraPeserta2);
        mSah= findViewById(R.id.SahkanAcaraPeserta1);
